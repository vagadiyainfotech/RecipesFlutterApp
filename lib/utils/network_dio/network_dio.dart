...
import 'package:indianfastfoodrecipes/utils/internet_error.dart';
import 'package:indianfastfoodrecipes/utils/process_indicator.dart';
import 'package:indianfastfoodrecipes/utils/repository/network_repository.dart';
  ...
  static Future<Map<String, dynamic>> getDioHttpMethod(
    ...
    if (internet) {
      ...
      try {
        ...
        log('\x1b[97m ${response.statusCode}');
        log('\x1b[97m ${response.data}');
        // ignore: prefer_typing_uninitialized_variables
        var responseBody;
        ...
        Map<String, dynamic> responseData = {
          ...
          'error_description': e.response!.data.toString().contains('detail')
              ? null
